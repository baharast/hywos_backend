...
class StoreTrailerRequest extends FormRequest
{
    ...
    {
        return [
            // Optional — auto-generated by TrailerController::nextTrailerCode()
            // when omitted. The unique index still rejects collisions when an
            // external import passes its own code.
            'trailer_code' => 'nullable|string|max:50|unique:trailers,trailer_code',
